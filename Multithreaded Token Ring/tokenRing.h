...
int runSimulation(struct TokenRingData *simulationData, int numPackets, pthread_t ptid[N_NODES]);
int cleanupSystem(struct TokenRingData *simulationData, pthread_t ptid[N_NODES]);
